...
public class Utilisateur {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Affichage du catalogue après " + "annulation de la première commande");
        catalogue.affiche();
        System.out.println();
        catalogue.retablitCommandeSolder(1);
        System.out.println("Affichage du catalogue après " + "rétablissement de la première commande");
        catalogue.affiche();
        System.out.println();
    }
}
